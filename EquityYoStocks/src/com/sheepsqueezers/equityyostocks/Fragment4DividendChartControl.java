...
public class Fragment4DividendChartControl extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater,ViewGroup container,Bundle savedInstanceState) {
		...
		oFragment4DividendChart = inflater.inflate(R.layout.fragment4_dividend,container,false); 

		//Set up the price chart.
        igDivChart = (DataChart) oFragment4DividendChart.findViewById(R.id.igDivChart);
